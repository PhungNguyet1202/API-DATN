...
<main>
    <div class="container custom-section">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                {{-- <img src="../img/slide-1.jpg" alt="Pet Care"  class="img-fluid custom-rounded"> --}}
                <img src="{{ asset('assets/pethaven/public/img/slide-1.jpg') }}" alt="Pet Care" class="img-fluid custom-rounded">
...
<section class="pet-services py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-3 ">
                <div class="service-card text-center p-3">
                    <img src="{{ asset('assets/pethaven/public/img/service-01.jpg') }}" class="rounded-circle mb-3" alt="Chăm sóc y tế"> <!-- Thay bằng link hình ảnh của bạn -->
            ...
            <div class="col-md-3 service">
                <div class="service-card text-center p-3">
                    <img src="{{ asset('assets/pethaven/public/img/service-02.jpg')}}" class="rounded-circle mb-3" alt="Chăm sóc và huấn luyện"> <!-- Thay bằng link hình ảnh của bạn -->
   ...
   <div class="col-md-3 service">
    <div class="service-card text-center p-3">
        <img src="{{ asset('assets/pethaven/public/img/service-04.jpg')}}" class="rounded-circle mb-3" alt="Chăm sóc và huấn luyện"> <!-- Thay bằng link hình ảnh của bạn -->
        ...
        <p class="content-description">Cung cấp kiểm tra sức khỏe định kỳ, tiêm phòng, điều trị bệnh, và các dịch vụ y tế khác cho thú cưng của bạn.</p>
            ...
            <div class="col-md-3 service">
                <div class="service-card text-center p-3">
                    <img src="{{ asset('assets/pethaven/public/img/service-03.jpg')}}" class="rounded-circle mb-3" alt="Nơi ở và bảo mẫu"> <!-- Thay bằng link hình ảnh của bạn -->
...
<div class="container-fluid banner">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6">
          <img src="{{ asset('assets/pethaven/public/img/banner-duoi.png')}}" alt="Pet Care Image">
        </div>
  ...
  <div class="container my-5">
    <div class="row">
      <div class="col-md-3">
        <div class="gallery-item" onclick="xemChiTiet('{{ asset('assets/pethaven/public/img/pet1.jpg')}}')">
          <img src="{{ asset('assets/pethaven/public/img/pet1.jp')}}g" alt="Ảnh thú cưng">
          <div class="overlay">
      ...
      <div class="col-md-3">
        <div class="gallery-item" onclick="xemChiTiet('{{ asset('assets/pethaven/public/img/pet2.jpg')}}')">
          <img src="{{ asset('assets/pethaven/public/img/pet2.jpg')}}" alt="Ảnh thú cưng">
          <div class="overlay">
            <div class="plus-circle">+</div>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="gallery-item" onclick="xemChiTiet('{{ asset('assets/pethaven/public/img/pet4.jpg')}}')">
          <img src="{{ asset('assets/pethaven/public/img/pet4.jpg')}}" alt="Ảnh thú cưng">
          <div class="overlay">
            <div class="plus-circle">+</div>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="gallery-item" onclick="xemChiTiet('{{ asset('assets/pethaven/public/img/pet3.jpg')}}')">
          <img src="{{ asset('assets/pethaven/public/img/pet3.jp')}}g" alt="Ảnh thú cưng">
          <div class="overlay">
            <div class="plus-circle">+</div>
          </div>
        </div>
  ...
  <div class="container comment-service ">
    <div class="row">
                    ...
                    <div class="carousel-item active">
                        <div class="customer-review text-start">
                            <div class="d-flex align-items-center justify-content-start mb-4">
                                <img src="{{ asset('assets/pethaven/public/img/anh-comment.jpg')}}" alt="Customer Image" class="customer-img me-3">
                                <div>
        ...
        <div class="col-md-6 side-img">
            <img src="{{ asset('assets/pethaven/public/img/slide-1.jpg')}}" alt="Side Image" class="img-fluid">
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-around">
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="expert-card bg-light">
          <img src="{{ asset('assets/pethaven/public/img/nv1.jpg')}}" alt="Thùy Dương">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="expert-card bg-light">
          <img src="{{ asset('assets/pethaven/public/img/nv1.jpg')}}" alt="Văn Long">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="expert-card bg-light">
          <img src="{{ asset('assets/pethaven/public/img/nv1.jpg')}}" alt="Linh Min">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card news-card position-relative">
          <img src="{{ asset('assets/pethaven/public/img/tt1.jp')}}g" alt="news image">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card news-card position-relative">
          <img src="{{ asset('assets/pethaven/public/img/tt2.jpg')}}" alt="news image">
          <span class="badge">04 TH5</span>
          <div class="card-body">
            <p class="news-meta">
              <i class="fa-solid fa-tag" style="color: #008BA7;"></i> Health Care 
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card news-card position-relative">
          <img src="{{ asset('assets/pethaven/public/img/tt3.jpg')}}" alt="news image">
          <span class="badge">04 TH5</span>
          <div class="card-body">
            <p class="news-meta">
              <i class="fa-solid fa-tag" style="color: #008BA7;"></i> Health Care 
